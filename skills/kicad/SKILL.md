...
description: >-
  ...
  On Matt's machines this skill runs INSIDE the MS PCB Design Doctrine platform (rp1-home epic #1441) — every review applies DOCTRINE.md rules, runs the kicad-lint gate first, and renders via kicad-visual-verify after any edit; use it for "is this board doctrine-compliant", "lint my schematic", "review against our rules".
---
